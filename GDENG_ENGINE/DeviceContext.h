...
public:
	...
	void drawIndexedTriangleList(UINT index_count, UINT vertex_count, UINT start_vertex_index, UINT start_index_location);
	void drawIndexedLineList(UINT index_count, UINT vertex_count, UINT start_vertex_index, UINT start_index_location);
