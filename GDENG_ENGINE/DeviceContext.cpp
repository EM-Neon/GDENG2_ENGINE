...
void DeviceContext::clearRenderTargetColor(const SwapChainPtr& swap_chain, float red, float green, float blue, float alpha)
{
	...
	//m_device_context->OMSetRenderTargets(1, &swap_chain->renderView, NULL);
...
void DeviceContext::drawIndexedTriangleList(UINT index_count, UINT vertex_count, UINT start_vertex_index,
...
void DeviceContext::drawIndexedLineList(UINT index_count, UINT vertex_count, UINT start_vertex_index, UINT start_index_location)
{
